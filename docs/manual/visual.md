...
This mode features an [integrated version](https://github.com/igvteam/igv.js) of [Integrative Genomics Viewer (IGV)](http://software.broadinstitute.org/software/igv/):
