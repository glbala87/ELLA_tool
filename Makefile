...
e2e-test-local: test-build
	...
	docker run --name ella-e2e-local -it -v $(shell pwd):/ella -p 8888:8888 -p 5000:5000 -p 5859:5859 $(IMAGE_NAME) /bin/bash -c "make e2e-ella; echo \"Run 'make wdio' to run e2e tests\"; /bin/bash"
