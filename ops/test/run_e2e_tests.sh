...
#find  src/webui/tests/e2e/tests -name "*.js" | grep "workflow_variant_acmg" | sort | /dist/node_modules/webdriverio/bin/wdio --baseUrl "${E2E_APP_CONTAINER}:5000" --host "cb" --port 4444 --path "/" /ella/src/webui/tests/e2e/wdio.conf.js
