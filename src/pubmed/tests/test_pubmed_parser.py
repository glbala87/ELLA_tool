...
def test_parse_pubmed_article(test_references):
    ...
    if '24122059' in reference['pubmed_id']:
        ...
        print(reference)
    if '23374456' in reference['pubmed_id']:
        # Test for no issue
        assert reference['journal'] == 'J Med Case Rep: 7, 35.'
    else:
        print(reference)
    if '21550946' in reference['pubmed_id']:
        # Test one author
        ...
        print(reference)
    if '16160809' in reference['pubmed_id']:
        # Test two authors
        ...
        print(reference)
    if '24891336' in reference['pubmed_id']:
