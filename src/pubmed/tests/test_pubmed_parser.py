...
def test_parse_pubmed_article(test_references):
    ...
    if '24122059' in reference['URL']:
        ...
        print(reference)
    if '23374456' in reference['URL']:
        # Test for no issue
        assert reference['journal'] == 'J Med Case Rep: 7, 35.'
    else:
        print(reference)
    if '21550946' in reference['URL']:
        # Test one author
