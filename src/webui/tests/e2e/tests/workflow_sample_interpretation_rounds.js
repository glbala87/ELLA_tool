...
describe('Sample workflow ', function() {
    ...
    it('classifies variants and sets to review', function() {
        ...
        expect(analysisPage.title).toBe('brca_e2e_test01.HBOCUTV_v1.0.0' + TITLE_INTERPRETATION)
    ...
    it('reclassifies variants and sets to medical review', function() {
        ...
        expect(analysisPage.title).toBe('brca_e2e_test01.HBOCUTV_v1.0.0' + TITLE_REVIEW)
    ...
    it('can change classfications from previous round and finalize', function() {
        ...
        expect(analysisPage.title).toBe('brca_e2e_test01.HBOCUTV_v1.0.0' + TITLE_MEDICAL_REVIEW)
    ...
    it('shows existing classifications and finalize', function() {
        ...
        expect(analysisPage.title).toBe('brca_e2e_test02.HBOCUTV_v1.0.0' + TITLE_INTERPRETATION)
