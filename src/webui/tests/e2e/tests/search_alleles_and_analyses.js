...
describe('Search functionality', function() {
    ...
    it('shows connected analyses', function() {
        ...
        expect(analyses).toEqual([
            'brca_e2e_test01.HBOCUTV_v1.0 HTS',
            'brca_e2e_test02.HBOCUTV_v1.0 HTS'
        ])
    })
    ...
    it('filter analyses', function() {
        ...
        browser.psql(
            ...
            WHERE name = 'brca_e2e_test01.HBOCUTV_v1.0';`
        )
        ...
        browser.psql(
            ...
            WHERE name = 'brca_e2e_test02.HBOCUTV_v1.0';`
        )
        // add review comment
        browser.psql(
            `INSERT INTO interpretationlog (
                ...
                (
                    ...
                    WHERE name = 'brca_e2e_test03.HBOCUTV_v1.0'
                ),
                1,
                current_timestamp,
                'TEST'
