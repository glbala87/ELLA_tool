...
function getTree(node) {
    ...
    return [node.nodeName].concat(getTree(node.parentElement))
}
...
@Directive({
    ...
    template: '<div class="wysiwygeditor" spellcheck="false" ng-disabled="vm.ngDisabled" ng-model="comment.model.comment"></div>' +
              ...
              '<div class="wysiwygbuttons">' +
                ...
                '<button class="wysiwygbutton" title="Set text color" id="wysiwyg-color">A<span style="color: rgba(129,62,49,0.95); vertical-align: sub; margin-left: -0.0rem">&#9646</span></button>' +
