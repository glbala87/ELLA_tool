...
class TestVCFHelperFunctions(unittest.TestCase):
    ...
    def test_translates_illegal_characters(self):
        ...
        self.assertEqual(vc.translate_illegal("EFF=nasty, and,;"),
                         "EFF@#EQnasty@#CM@#SPand@#CM@#SC")
    ...
    def test_translates_back_to_original_characters(self):
        ...
        self.assertEqual(vc.translate_to_original("EFF@#EQnasty@#CM@#SPand@#CM@#SC"), "EFF=nasty, and,;")
...
class TestVCFAlleleCreator(unittest.TestCase):
    ...
    def mockseq(self, chromosome, start, stop, returnValue):
        ...
        self.seqdb[chromosome].AndReturn(self.mox.CreateMockAnything())[start:stop].AndReturn(returnValue)
    ...
    def test_snp_verifies_reference(self):
        ...
        self.mox.ReplayAll()
        self.assertEqual(self.v.snp('1', 10, 'A', 'T', 'id1'), ('1', '11', 'id1', 'A', 'T'))
        self.assertEqual(self.v.refMismatch, [("SNP", 'G', '1', 10, 'A', 'T', 'id1')]) # type, genomeref, restofinput
        self.mox.VerifyAll()
