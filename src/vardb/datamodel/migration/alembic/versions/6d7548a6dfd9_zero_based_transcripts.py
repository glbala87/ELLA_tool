"""zero_based_transcripts

Revision ID: 6d7548a6dfd9
Revises: fdbb9cbd41ad
Create Date: 2018-05-28 09:03:05.047677

"""

# revision identifiers, used by Alembic.
revision = '6d7548a6dfd9'
down_revision = 'fdbb9cbd41ad'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    for t in transcripts:
        ...
        conn.execute(
            sa.update(Transcript).where(
                Transcript.c.id == t.id
            ).values(
                **values
            )
        )
