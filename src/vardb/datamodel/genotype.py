...
class GenotypeSampleData(Base):
    ...
    type = Column(Enum("Homozygous", "Heterozygous", "Reference", "No coverage", name="genotypemetadata_genotype"))  # The sample's genotype in relation to the proband's variant.
