...
ht.settings.register_profile("extensive", max_examples=3000, timeout=900, suppress_health_check=[ht.HealthCheck.hung_test], deadline=2000)
ht.settings.register_profile("soak", max_examples=1000000, timeout=ht.unlimited, suppress_health_check=[ht.HealthCheck.hung_test], deadline=2000)
