...
class GrmTest(unittest.TestCase):
    ...
    def testComplexCompositeRule(self):
        ...
        self.assertEquals(orrule.query(["transcript_ablation", "splice_donor_variant", "stop_gained"]), [rule1_1, rule1_2, rule1_3])
        self.assertEquals(orrule.query(["transcript_ablation", "splice_donor_variant", "stop_gained"])[0].source, "VEP consequence")
        self.assertEquals(orrule.query(["in_cis_pathogenic", "in_trans_pathogenic"]), [rule2_1, rule2_2])
        self.assertEquals(orrule.query(["in_cis_pathogenic", "in_trans_pathogenic"])[0].source, "Phase")
        self.assertFalse(orrule.query(["transcript_ablation", "splice_donor_variant","in_cis_pathogenic"]))
    ...
    def testAllRule(self):
        ...
        self.assertEquals(rule.query(["rBP7-1", "rBP7-2","rBP7-4","rBP7-3","rBP7-5", "rBP7-4"]), [rule])
        self.assertEquals(rule.query(["rBP7-1", "rBP7-2","rBP7-3","rBP7-4","rBP7-5", "and"]), [rule])
        self.assertEquals(rule.query(["rBP7-1", "rBP7-2","rBP7-3","rBP7-4","rBP7-5", "and", "more"]), [rule])
    ...
    def testAllRuleWildcard(self):
        ...
        self.assertEquals(rule.query(["rBP7-1", "rBP7-2","rBP7-4","PP5","rBP7-5", "BP6", "rBP7-4"]), [rule])
