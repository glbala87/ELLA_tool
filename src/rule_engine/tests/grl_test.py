...
class GrlTest(unittest.TestCase):
    ...
    def testParseBasicRuleList(self):
        ...
        self.assertEquals(rules["rBP7-1"][0].value, ["stop_retained_variant",
                                                     "5_prime_UTR_variant",
                                                     "3_prime_UTR_variant",
                                                     "non_coding_exon_variant",
                                                     "nc_transcript_variant",
    ...
    def testParseCompositeRules(self):
        ...
        self.assertEquals(rules["MYAND"][0].subrules[1].value, ["missense_variant", "synonymous_variant"])
        ...
        self.assertTrue(isinstance(rules["MYCOMPLEX"][0].subrules[1].subrules[2].subrules[0], GRM.InRule))
        self.assertEquals(rules["MYCOMPLEX"][0].subrules[1].subrules[2].subrules[0].source, "e.f.g")
        self.assertEquals(rules["MYCOMPLEX"][0].subrules[1].subrules[2].subrules[0].value, ["0.001"])
        self.assertTrue(isinstance(rules["MYCOMPLEX"][0].subrules[1].subrules[2].subrules[1], GRM.InRule))
        self.assertEquals(rules["MYCOMPLEX"][0].subrules[1].subrules[2].subrules[1].source, "h.jjj")
        self.assertEquals(rules["MYCOMPLEX"][0].subrules[1].subrules[2].subrules[1].value, ["more", "values"])
    ...
    def testRuleAgGRMgationAll(self):
        jsonstring = [
                      ...
                      {
                       "code": "rBP7-4",
                       "rule": {"transcript.splice.power": "some_effect"}
                       },
                      {
                       "code": "BP7",
                      ...
                      {
                       "code": "PP7",
                       "rule": {"$$aggregate": {"$all": ["BP7", "rBP7-4"]}}
                       },
                      {
                       "code": "PP8",
                       "rule": {"$$aggregate": {"$not": {"$all": ["BP7", "rBP7-4"]}}}
                       }
                      ]
        rules = self.parseJson(jsonstring)
    ...
    def testRuleAggregationComposite(self):
        jsonstring = [
                      ...
                      {
                       "code": "BP8",
                       "rule": {"$$aggregate": {"$atleast": [1, "rBP7-4", "rBP7-5"]}}
                       },
                      {
                       "code": "BP9",
    ...
    def testRuleAgGRMgationAtLeast(self):
        jsonstring = [
                      ...
                      {
                       "code": "rBP7-2",
                       "rule": {"genomic.Onservation": "conserved"}
                       },
                      {
                       "code": "PP7",
