...
def test_resolver_uses_genepanel_defined_cutoffs(session):
    ...
    assert props['freq_cutoffs']['external']['hi_freq_cutoff'] == acmgconfig['frequency']['thresholds']['default']['external']['hi_freq_cutoff']
    assert props['freq_cutoffs']['external']['lo_freq_cutoff'] == acmgconfig['frequency']['thresholds']['default']['external']['lo_freq_cutoff']
    assert props['freq_cutoffs']['internal']['hi_freq_cutoff'] == acmgconfig['frequency']['thresholds']['default']['internal']['hi_freq_cutoff']
    assert props['freq_cutoffs']['internal']['lo_freq_cutoff'] == acmgconfig['frequency']['thresholds']['default']['internal']['lo_freq_cutoff']
    ...
    assert props['freq_cutoffs']['external']['hi_freq_cutoff'] == acmgconfig['genes']['1101']['frequency']['thresholds']['external']['hi_freq_cutoff']
    assert props['freq_cutoffs']['external']['lo_freq_cutoff'] == acmgconfig['genes']['1101']['frequency']['thresholds']['external']['lo_freq_cutoff']
    assert props['freq_cutoffs']['internal']['hi_freq_cutoff'] == acmgconfig['genes']['1101']['frequency']['thresholds']['internal']['hi_freq_cutoff']
    assert props['freq_cutoffs']['internal']['lo_freq_cutoff'] == acmgconfig['genes']['1101']['frequency']['thresholds']['internal']['lo_freq_cutoff']
